function AdminContactMessageFilter({
  filters,
  setFilters,
  onSubmit,
  onReset,
  ...
  return (
    <div className="rounded-lg bg-white p-5 shadow-sm">
      <form
        onSubmit={onSubmit}
        className="grid gap-4 lg:grid-cols-[1fr_220px_160px_140px]"
      >
        <div>
          ...
          <input
            ...
            placeholder="Tên, email, SĐT, chủ đề..."
...
export default AdminContactMessageFilter